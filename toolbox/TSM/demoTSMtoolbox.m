...
warning('OFF','MATLAB:audiovideo:wavwrite:dataClipped');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1. load the audio signal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[x,fsAudio] = wavread([pathData filename]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OLA
wavwrite(yOLA,fsAudio,[pathOutput filename(1:end-4)...
    '_' sprintf('%0.2f',alpha) '_OLA.wav']);

% WSOLA
wavwrite(yWSOLA,fsAudio,[pathOutput filename(1:end-4)...
    '_' sprintf('%0.2f',alpha) '_WSOLA.wav']);

% Phase Vocoder
wavwrite(yPV,fsAudio,[pathOutput filename(1:end-4)...
    '_' sprintf('%0.2f',alpha) '_PV.wav']);

% Phase Vocoder with identity phase locking
wavwrite(yPVpl,fsAudio,[pathOutput filename(1:end-4)...
    '_' sprintf('%0.2f',alpha) '_PVpl.wav']);

% TSM based on HPSS
wavwrite(yHP,fsAudio,[pathOutput filename(1:end-4)...
    '_' sprintf('%0.2f',alpha) '_HP.wav']);
