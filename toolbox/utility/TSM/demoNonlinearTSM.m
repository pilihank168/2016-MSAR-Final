...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[x1,~      ] = wavread([pathData filenameWav1]);
[x2,fsAudio] = wavread([pathData filenameWav2]);
...
wavwrite([x1 x2_padded],fsAudio,...
    [pathOutput 'BeethovenPianoOrchestra_unsync.wav']);

% synchronized recordings
% write stereo file: left channel: original piano version, right channel:
% stretched orchestra version
wavwrite([x1 y],fsAudio,...
    [pathOutput 'BeethovenPianoOrchestra_sync.wav']);
